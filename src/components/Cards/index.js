        ...
        <div>
            <div className="col s4">
                <div  className="card z-depth-4">
                    ...
                    <div className="card-content">
                        ...
                        <a className="card-action btn text-center green modal-trigger" style={buttonStyle} href={"#" + props.description}>Testing testing</a>
                    </div>
                </div>
            </div>
            <div style={modalStyle} id={props.description} className="modal animated flipInY">
                ...
                <div className="modal-footer">
                    <a href="#" className="modal-close waves-effect green waves-red btn-flat">Testing</a>
                    <a href="#!" className="modal-close waves-effect red waves-red btn-flat">123</a>
                </div>
            </div>
        </div>
    )
